...
public class DateUtils {
    ...
    public static String dateStrToFormatStr(String oriStr){
        Date dt = parseDate(oriStr);

        if(dt == null){
            return "";
        }

        return parseDateToStr(YYYY_MM_DD_HH_MM_SS,dt);
    }
    /**
     * 获取当前Date型日期
     *
    ...
    public static final String shortTime(Date dt)
    {
    ...
    public static Long getDatePoorMiliSeconds(Date endDate, Date nowDate)
    {
        // 获得两个时间的毫秒时间差异
        long diff = endDate.getTime() - nowDate.getTime();
